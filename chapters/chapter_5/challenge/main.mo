...
actor {
    ...
    let name = "Alegra Studio DAO";
    var manifesto = "En Alegra Studio DAO, creemos en un futuro donde la tecnología blockchain y las artes se unen para generar un impacto positivo en nuestra sociedad y medio ambiente.";
            ...
            case (?member) {
                ...
                switch (proposals.get(proposalId)) {
                    ...
                    case (?proposal) {
                        ...
                        if (newVoteScore < -100 or newVoteScore > 100) {
                            return #err("The vote would make the proposal score exceed the limits");
                        };
